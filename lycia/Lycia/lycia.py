...
async def lycia(client, message):
    ...
    if chat_id in en_chats:
        ...
        result = result.replace("Eliza", "@MilanKiGF_bot)
        result = result.replace("Hi~", "Hello Friend I Am @MilanKiGF_bot")
        result = result.replace("My dear great botmaster, Lyciabot Team.", "Made By @patelmilan07")
        result = result.replace("Have the control right.", "My Father Is @patelmilan07")
        result = result.replace("I was created by Python Experts Team.", "I was created by @patelmilan07 Team.")
...
async def redaura(client, message):
    ...
    result = result.replace("Eliza", "@MilanKiGF_bot")
    result = result.replace("Hi~", "Hello Friend I Am @MilanKiGF_bot")
    result = result.replace("My dear great botmaster, Daisybot Team.", "Made By @patelmilan07")
    result = result.replace("Have the control right.", "My Father Is @patelmilan07")
    result = result.replace("I was created by Python Experts Team.", "I was created by @patelmilan07 Team.")
    result = result.replace("<a href=\\", "<a href =")
    result = result.replace("<\/a>", "</a>")
